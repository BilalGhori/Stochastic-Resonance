%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Plot Manuscript Figure 8a
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% loading data files 
function plot_Manuscript_Fig8a()
%close all;

addpath('figure8data')

file=['load figure8a_data.mat'];eval(file);
...
line([2.4 2.4 nan 2.4 2.4],[0 0.11027 nan 0 0.11027],'color','k','LineStyle','--') % draw a vertical line through peak C1
line([0 2.4-0.11027],[0.11027 0.11027],'color','k','LineStyle','--')         % draw a horizontal line through peak C1
line([0 0.11027],[0.11027 0.11027],'color','k','LineStyle','--')
txt1 = '\phi_{s}';text(-1,0.11027,txt1,'color','k','fontsize',  14,'fontweight','bold')
