%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Plot Figure 6b (Dendritic stimulation) 
% Power norm C1 vs noise perturbation intensity,E[Arms])
% Biphasic stochastic pulse train perturbation 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function plot_manuscript_figure6b()

addpath('figure6data')

load('figure6bdata_dendritic')
...
txt1 = '\phi_{d}';text(3.95,0.314,txt1,'color','k','fontsize',  14,'fontweight','bold')
